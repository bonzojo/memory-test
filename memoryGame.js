...
const setMemoryImage = (score) => {
    if(score >= 1 && score <= 100){
        memoryImage.setAttribute('src', '/goldfish.png');
    } else if(score > 100 && score <= 300){
        memoryImage.setAttribute('src', '/dog.png');
    } else if(score > 300 && score <= 500){
        memoryImage.setAttribute('src', '/horse.png');
    } else if(score > 500){
        memoryImage.setAttribute('src', '/elephant.png');
    } else {
