...
const setMemoryImage = (score) => {
    if(score >= 1 && score <= 100){
        memoryImage.setAttribute('src', '/memory-test/resources/images/goldfish.png');
    } else if(score > 100 && score <= 300){
        memoryImage.setAttribute('src', '/memory-test/resources/images/dog.png');
    } else if(score > 300 && score <= 500){
        memoryImage.setAttribute('src', '/memory-test/resources/images/horse.png');
    } else if(score > 500){
        memoryImage.setAttribute('src', '/memory-test/resources/images/elephant.png');
    } else {
